...
export default function HeroSection4() {
  ...
  return (
    <section className="relative pt-17">
      <div className="relative z-20 bg-[#1a2e1c] py-2.5 px-4">
        <div className="mx-auto flex max-w-160 items-center gap-2.5 rounded-xl bg-white pb-1.5 pl-4 pr-1.5 pt-1.5 shadow-[0_8px_48px_rgba(0,0,0,0.35)]">
          <svg
            className="shrink-0"
            width="20"
            height="20"
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-160 text-center">
          ...
          <p className="text-[clamp(1rem,2.5vw,1.15rem)] leading-[1.65] text-white/82">
