  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[640px] text-center">
        ...
        <p className="mb-9 text-[clamp(1rem,2.5vw,1.15rem)] leading-[1.65] text-white/[0.82]">
          Every dollar spent local, stays local, support genuine, unique businesses
        </p>

        <div className="mb-6 flex items-center gap-[10px] rounded-xl bg-white pb-[6px] pl-4 pr-[6px] pt-[6px] shadow-[0_8px_48px_rgba(0,0,0,0.35)]">
          <svg
            className="shrink-0"
            width="20"
            height="20"
          ...
          <button
            ...
            className="shrink-0 cursor-pointer whitespace-nowrap rounded-lg bg-[#3a6e3f] px-[22px] py-[11px] text-[0.9rem] font-semibold text-white transition-colors duration-[150ms] hover:bg-[#2a4d2f]"
          >
            Search
          </button>
        </div>
            ...
            <button
              ...
              className={
                selectedCategory === cat.slug
                  ? 'cursor-pointer whitespace-nowrap rounded-full border-[1.5px] border-white bg-white px-[18px] py-[7px] text-sm font-semibold text-[#3a6e3f] transition-colors duration-[150ms]'
                  : 'cursor-pointer whitespace-nowrap rounded-full border-[1.5px] border-white/35 bg-transparent px-[18px] py-[7px] text-sm text-white/85 transition-colors duration-[150ms] hover:border-white/70 hover:bg-white/[0.18] hover:text-white'
              }
            >
              {cat.name}
            </button>
