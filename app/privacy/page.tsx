  ...
  return (
    <main className="min-h-screen bg-[#f7f7f5] pt-24 pb-16 px-5">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mb-2 text-3xl font-bold tracking-tight text-[#1a1a1a]">Privacy Policy</h1>
        ...
        {/* 1 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">1. Information We Collect</h2>

        <h3 className="mb-2 mt-6 text-base font-semibold text-[#1a1a1a]">Information you provide directly</h3>
        ...
        <h3 className="mb-2 mt-6 text-base font-semibold text-[#1a1a1a]">Information collected automatically</h3>
        <ul className="mb-4 list-disc list-inside space-y-1 leading-relaxed text-[#444]">
        ...
        {/* 2 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">2. How We Use Your Information</h2>
        <p className="mb-3 leading-relaxed text-[#444]">We use the information we collect to:</p>
        <ul className="mb-4 list-disc list-inside space-y-1 leading-relaxed text-[#444]">
        ...
        <p className="mb-4 leading-relaxed text-[#444]">We do not sell your personal information to third parties.</p>

        <hr className="my-8 border-t border-black/10" />

        {/* 3 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">3. How We Share Your Information</h2>
        <p className="mb-4 leading-relaxed text-[#444]">
        ...
        <p className="mb-4 leading-relaxed text-[#444]">We do not share your personal information with advertisers or marketing companies.</p>

        <hr className="my-8 border-t border-black/10" />

        {/* 4 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">4. Data Retention</h2>
        <p className="mb-4 leading-relaxed text-[#444]">
        ...
        {/* 5 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">5. Security</h2>
        <p className="mb-4 leading-relaxed text-[#444]">
        ...
        {/* 6 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">6. Children&apos;s Privacy</h2>
        <p className="mb-4 leading-relaxed text-[#444]">
        ...
        {/* 7 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">7. Third-Party Links</h2>
        <p className="mb-4 leading-relaxed text-[#444]">
        ...
        {/* 8 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">8. Future Payment Processing</h2>
        <p className="mb-4 leading-relaxed text-[#444]">
        ...
        {/* 9 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">9. Your Rights</h2>
        <p className="mb-3 leading-relaxed text-[#444]">You have the right to:</p>
        <ul className="mb-4 list-disc list-inside space-y-1 leading-relaxed text-[#444]">
        ...
        {/* 10 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">10. Changes to This Policy</h2>
        <p className="mb-4 leading-relaxed text-[#444]">
        ...
        {/* 11 */}
        <h2 className="mb-3 mt-10 text-lg font-bold text-[#1a1a1a]">11. Contact Us</h2>
        <p className="mb-4 leading-relaxed text-[#444]">
